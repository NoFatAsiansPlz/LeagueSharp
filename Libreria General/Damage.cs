            ...
            Spells.Add(
                "Ahri", new List<DamageSpell>
                {
                    ...
                    new DamageSpell
                    {
                        ...
                        Damage =
                            (source, target, level) =>
                                new double[] { 60, 90, 120, 150, 180 }[level] + 0.35 * source.FlatMagicDamageMod
                    },
                    //R, per dash
                    new DamageSpell
                    {
            ...
            Spells.Add(
                "Azir", new List<DamageSpell>
                {
                    ...
                    new DamageSpell
                    {
                        ...
                        Damage =
                            (source, target, level) =>
                                new double[] { 75, 105, 135, 165, 195 }[level] + 0.5 * source.FlatMagicDamageMod
                    },
                    //E
                    new DamageSpell
                    {
            ...
            Spells.Add(
                "Fizz", new List<DamageSpell>
                {
                    ...
                    new DamageSpell
                    {
                        ...
                        Damage =
                            (source, target, level) =>
                                new double[] { 10, 40, 70, 100, 130 }[level] + 0.6 * source.FlatMagicDamageMod
                    },
                    //W - Per attack
                    new DamageSpell
                    {
                        ...
                        Damage =
                            (source, target, level) =>
                                new double[] { 10, 15, 20, 25, 30 }[level] + 0.25 * source.FlatMagicDamageMod
                    },
                    //E
                    new DamageSpell
                    {
            ...
            Spells.Add(
                "Lissandra", new List<DamageSpell>
                {
                    ...
                    new DamageSpell
                    {
                        ...
                        Damage =
                            (source, target, level) =>
                                new double[] { 75, 110, 145, 180, 215 }[level] + 0.65 * source.FlatMagicDamageMod
                    },
                    //W
                    new DamageSpell
                    {
            ...
            Spells.Add(
                "Nautilus", new List<DamageSpell>
                {
                    ...
                    new DamageSpell
                    {
                        ...
                        Damage =
                            (source, target, level) =>
                                new double[] { 40, 55, 70, 85, 100 }[level] + 0.4 * source.FlatMagicDamageMod
                    },
                    //E
                    new DamageSpell
                    {
                        ...
                        Damage =
                            (source, target, level) =>
                                new double[] { 60, 100, 140, 180, 220 }[level] + 0.5 * source.FlatMagicDamageMod
                    },
                    //R - main target
                    new DamageSpell
                    {
                    ...
                    new DamageSpell
                    {
                        ...
                        Damage =
                            (source, target, level) =>
                                ...
                                (new double[] { 10, 12, 14, 16, 18 }[level] / 100 +
                                 0.02 / 100 * source.FlatMagicDamageMod) * target.Health
                    },
                    //W - cat
                    new DamageSpell
                    {
            ...
            Spells.Add(
                "Skarner", new List<DamageSpell>
                {
                    ...
                    new DamageSpell
                    {
                        ...
                        Damage =
                            (source, target, level) =>
                                new double[] { 18, 28, 38, 48, 58 }[level] + 0.4 * source.FlatPhysicalDamageMod
                    },
                    //E
                    new DamageSpell
                    {
            ...
            Spells.Add(
                "Tristana", new List<DamageSpell>
                {
                    ...
                    new DamageSpell
                    {
                        ...
                        Damage =
                            (source, target, level) =>
                                new double[] { 80, 125, 170, 215, 260 }[level] + 1 * source.FlatMagicDamageMod
                    },
                    //R
                    new DamageSpell
                    {
                        ...
                        Damage =
                            (source, target, level) =>
                                new double[] { 300, 400, 500 }[level] + 1.5 * source.FlatMagicDamageMod
                    },
                });
            ...
            Spells.Add(
                "Vi", new List<DamageSpell>
                {
                    ...
                    new DamageSpell
                    {
                        ...
                        Damage =
                            (source, target, level) =>
                                new double[] { 200, 325, 450 }[level] + 1.4 * source.FlatPhysicalDamageMod
                    },
                });
            ...
            Spells.Add(
                "XinZhao", new List<DamageSpell>
                {
                    ...
                    new DamageSpell
                    {
                        ...
                        Damage =
                            (source, target, level) =>
                                new double[] { 70, 105, 140, 175, 210 }[level] + 0.6 * source.FlatMagicDamageMod
                    },
                    //R
                    new DamageSpell
                    {
